from code.CNN_code.Dataset_Loader_CNN_MNIST import Dataset_Loader
from code.CNN_code.Method_CNN_MNIST import Method_CNN_MNIST
...
if 1:
    ...
    result_obj.result_destination_folder_path = '../../result/CNN_result/CNN_MNIST_'
